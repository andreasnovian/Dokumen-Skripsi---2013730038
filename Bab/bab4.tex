...
Setiap kata dasar disimpan pada sebuah file yang bernama sama dengan kata dasar yang disimpan dan berekstensi '.lxc' pada sebuah folder dalam program. Kata turunan untuk setiap kata dasar disimpan dalam file kata dasar yang bersangkutan. Isi dari setiap file tersebut adalah kata dasar diikuti oleh semua kemungkinan kata turunan yang dapat dibentuk dari kata dasar yang bersangkutan.
