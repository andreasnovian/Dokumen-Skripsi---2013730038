...
\begin{itemize}
	...
	\item Kata-kata serapan dari bahasa asing yang belum ada dalam Kamus Besar Bahasa Indonesia (KBBI) dianggap sebagai bentuk asing
	\item Kata yang dapat diproses adalah kata yang dibentuk dari proses morfologi berupa afiksasi, reduplikasi, dan komposisi
	\item Kata yang merupakan hasil proses penyisipan (infiksasi) tidak dapat diproses karena infiksasi dianggap sudah tidak produktif dalam bahasa Indonesia pada saat ini
\end{itemize}
